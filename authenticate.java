...
public class authenticate extends HttpServlet { 
	...
	MongoCollection<Document> collection = database.getCollection("users"); //mention the collection where you are storing the user credential details in place of "users"
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if (collection.find(and(eq("username", u_name), eq("password", pwd))).iterator().hasNext()) {  //in place of username and password, use the attributes which you have used to store the user details...
